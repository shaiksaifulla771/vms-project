    ...
    <BomPageWrapper>
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          {bom.status !== 'Deleted' && (
            <Button onClick={() => navigate(`/bom/${id}/edit`, { state: { returnTo: location.pathname } })} variant="outline" className="h-8 text-xs font-bold bg-blue-50 border-blue-200 text-blue-700 hover:bg-blue-100 hover:text-blue-800">
              <Edit2 className="w-3.5 h-3.5 mr-1.5" /> Edit Recipe
            </Button>
          )}
        </div>
      </div>
