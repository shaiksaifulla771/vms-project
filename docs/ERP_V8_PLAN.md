...
- 2026-09-24: Checked every place an MPN can appear. Pickers and filters already used the MPN list (no finished goods). Also removed the finished good's internal code from the API for: Material list/detail (no MPNs, no vendors), Products list, Vendor detail and vendor MPN/material counts, Stock Balance report and Physical Stock Sheet. New test; suite 71/71.
